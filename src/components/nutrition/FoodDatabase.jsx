    ...
    >
      <div className="relative w-full max-w-sm rounded-2xl bg-white p-8 shadow-2xl">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-lg font-bold text-[#0F172A]">Delete Food Item</h2>
          <p className="mt-2 text-sm text-[#64748B] leading-relaxed">
            Deleting this food item will remove all associated access,
            <br />
...
export function FoodDatabase() {
  ...
  const handleDeleteConfirm = (item) => {
    // TODO: wire to API
    console.log('Delete food', item.name)
  }
